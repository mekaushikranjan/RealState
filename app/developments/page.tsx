...
import { DevelopmentGrid } from "@/components/development-grid"
      ...
      <div className="relative w-full">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-10">
          <div className="text-center text-white">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">New Developments</h1>
            <p className="text-lg md:text-xl max-w-2xl mx-auto">
              Explore the latest and upcoming real estate developments in Dubai
            </p>
          </div>
        </div>
      </div>
