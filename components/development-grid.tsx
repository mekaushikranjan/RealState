...
function DevelopmentCards({ developments }: { developments: typeof developments }) {
  return (
        ...
        >
          <Card className="overflow-hidden h-full flex flex-col">
            ...
            <CardFooter className="p-4 pt-0 border-t">
              <Button className="w-full gap-2 bg-primary/10 hover:bg-primary/20 text-primary rounded-lg" asChild>
                <Link href={`/developments/${development.id}`}>
