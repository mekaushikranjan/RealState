      ...
      <div className="container mx-auto px-4">
        ...
        <Tabs defaultValue="sale" value={activeTab} onValueChange={setActiveTab} className="w-full">
          <div className="flex justify-center mb-8">
            <TabsList className="bg-white dark:bg-black border-2 border-gray-200 dark:border-gray-800">
              <TabsTrigger 
                value="sale"
...
function PropertyCard({ property, isFavorite, onFavoriteToggle, index }: PropertyCardProps) {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
    >
      <Card className="overflow-hidden h-full bg-white dark:bg-black border-2 border-gray-200 dark:border-gray-800">
        <div className="relative">
          ...
          >
            <Heart
              className={cn("h-5 w-5", isFavorite ? "fill-black text-black dark:fill-white dark:text-white" : "text-gray-600 dark:text-gray-400")}
            />
          </Button>
        ...
        <CardContent className="p-4">
          ...
          <Link href={`/properties/${property.id}`}>
            <h3 className="text-lg font-semibold mb-2 text-black dark:text-white hover:text-gray-600 dark:hover:text-gray-400 transition-colors">
              {property.title}
            </h3>
          </Link>
        ...
        <CardFooter className="p-4 pt-0 border-t border-gray-200 dark:border-gray-800 flex justify-between text-sm text-gray-600 dark:text-gray-400">
